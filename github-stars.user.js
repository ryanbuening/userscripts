...
const activateDirectlyOn = ['https://stackoverflow.com', /^https:\/\/.*\.stackexchange\.com/, googleUrl, /https:\/\/github.com(?!\/notifications)/, 'https://www.npmjs.com/package', 'https://www.nuget.org/packages'];
...
const blackList = ['', 'site', 'about', 'pricing', 'contact', 'topics', 'marketplace', 'blog', 'apps', 'features'];
